...
# print(pd.isnull(combined).sum())
teams = pd.read_csv("CSV/teamsGOOD.csv")
...
# print(teams)
nicknames = {}
with open("CSV/team_codes.csv", "r") as f:
    lines = f.readlines()
...
# print(pd.isnull(combined).sum())
# print(combined[combined["Team"].isnull()]["Tm"].unique())
# print(combined[combined["Team"].isnull()]["Year"].unique())
